(function ($) {
    ...
    if(url.includes('/packeges')){
        $('.dashboard-menu ul li a').removeClass('active')
        $('.dashboard-menu ul li a').eq(1).addClass('active')
    }
    if(url.includes('/invoices')){
        $('.dashboard-menu ul li a').removeClass('active')
        $('.dashboard-menu ul li a').eq(2).addClass('active')
    }
    if(url.includes('/Subscriber')){
        $('.dashboard-menu ul li a').removeClass('active')
        $('.dashboard-menu ul li a').eq(3).addClass('active')
    }
    if(url.includes('/Refrael')){
        $('.dashboard-menu ul li a').removeClass('active')
        $('.dashboard-menu ul li a').eq(4).addClass('active')
    }
    if(url.includes('/profile')){
        $('.dashboard-menu ul li a').removeClass('active')
        $('.dashboard-menu ul li a').eq(5).addClass('active')
    }

    // copy link refeal

    $('.copy-btn').on('click', function(){
        var textBox = document.getElementById("link-refral");
        textBox.select();
